    ...
    <main>
        <div class="container-fluid px-4">
            ...
            <ol class="breadcrumb mb-4">
                ...
                <li class="breadcrumb-item"><a href=" <?= base_url('rekap') ?> ">Pemasangan</a></li>
            ...
            <div class="row">
                <?php if (empty($isExists)) { ?>
                    <div class="col-xl-3 col-md-6">
                        <div class="card bg-success text-white mb-4">
                            <div class="card-body">Daftar Harga Borongan</div>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <a class="btn btn-warning btn-block m-2" href="<?= base_url('rekap/uraian/cetak/' . $invoice->id_pasang) ?>">
                        <i class="fas fa-print"></i> Cetak Rincian
                    </a>
                    <?php if ($totalbiaya > 0) { ?>
                        <a class="btn btn-dark btn-block m-2" href="<?= base_url('rekap/uraian/batal/' . $invoice->id_pasang) ?>">
                            ...
                            <ol class="list-group list-group-numbered">
                                <li class="list-group-item d-flex justify-content-between align-items-start">
                                    <div class="ms-2 me-auto">
                                        ...
                                        <?= date('d F Y', strtotime($invoice->tanggal)) ?>
                                    </div>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-start">
                                    <div class="ms-2 me-auto">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <ol class="list-group list-group-numbered">
                                <li class="list-group-item d-flex justify-content-between align-items-start">
                                    <div class="ms-2 me-auto">
                                        <div class="fw-bold">Pengerjaan</div>
                                        <?= $invoice->kerja; ?>
                                    </div>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-start">
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-start">
                                    <div class="ms-2 me-auto">
                                        <div class="fw-bold">Total Dael</div>
                                        <?= number_to_currency($invoice->biaya, 'IDR', 'id_ID') ?>
                                    </div>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-start">
                                    <div class="ms-2 me-auto">
                        ...
                        <button type="button" class="btn btn-info btn-block m-2" data-bs-toggle="modal" data-bs-target="#updateModal">
                            <i class="fas fa-edit"></i> Refisi Total Deal
                        </button>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= base_url('rekap/uraian/tambah') ?>" method="post">
                        <?= csrf_field() ?>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="id_survei" id="id_survei" class="form-control" value="<?= $invoice->id_survei; ?>" hidden>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= base_url('hbk/tambah') ?>" method="post" enctype="multipart/form-data">
                        <?= csrf_field() ?>
                        <input type="hidden" name="id_pasang" value="<?= $invoice->id_pasang; ?>">
                        <input type="hidden" name="kerja" value="<?= $invoice->kerja; ?>">
                        <input type="hidden" name="pengawas" value="<?= $invoice->pengukur; ?>">
                        <input type="hidden" name="drafter" value="<?= $invoice->drafter; ?>">
                        <input type="hidden" name="tukang" value="<?= $invoice->tukang; ?>">
                        <input type="hidden" name="total_hbk" value="0">
                        <div class="mb-3">
                            <label for="total_hbk">Keterangan</label>
        ...
        <div class="modal fade" id="ubahModal<?= $value->id; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action=" <?= base_url('rekap/uraian/ubah/' . $value->id) ?>" method="post">
                            <?= csrf_field() ?>
                            <input type="text" name="id_pasang" id="id_pasang" class="form-control" value="<?= $invoice->id_pasang; ?>" hidden>
                            <div class="mb-3">
        ...
        <div class="modal fade" id="hapusModal<?= $value->id; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action=" <?= base_url('rekap/uraian/hapus/' . $value->id) ?>" method="post">
                            <?= csrf_field() ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-info">
                    <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-plus"></i> Refisi Total Deal</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="<?= base_url('rekap/uraian/total/' . $invoice->id_pasang) ?>" method="post">
                        <?= csrf_field() ?>
                        <input type="hidden" name="_method" value="PUT">
                        <div class="mb-3">
                            <label for="biaya">Biaya Total</label>
                            <input type="text" name="biaya" id="biaya" class="form-control" value="<?= $invoice->biaya; ?>" required>
                        </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary btn-sm" data-bs-dismiss="modal">Batal</button>
