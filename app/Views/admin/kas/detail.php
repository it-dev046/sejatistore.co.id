    ...
    <main>
        <div class="container-fluid px-4">
            ...
            <ol class="breadcrumb mb-4">
                ...
                <li class="breadcrumb-item"><a href=" <?= base_url('kas/labarugi') ?> ">Laba Rugi</a></li>
                                ...
                                <tfoot>
                                    <tr>
                                        <th colspan="5" class="text text-center">
                                            Total Rekap Kategori Kas Bulan ini
                                        </th>
                                        <th>
                                            <?php if (empty($jumlahdebet)) { ?>
                                                0
                                            <?php } else { ?>
                    ...
                    <div class="modal-body">
                        <form action=" <?= base_url('kas/ubah/' . $value['id_kas']) ?>" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <label for="tanggal">Tanggal</label>
                                <input type="text" name="tanggal" id="tgl_ubah<?= $value['id_kas'] ?>" class="form-control" value="<?= $value['tanggal'] ?>" required>
                            </div>
                            <div class="mb-3">
                                <input type="hidden" name="_method" value="PUT">
