...
<main>
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-10 offset-md-1">
                <h5 class="card-title text-center"><strong>KWITANSI PEMBAYARAN</strong></h5>
                ...
                <div class="row justify-content-evenly">
                    <div class="col-3">
                        <table class="table table-sm table-borderless">
                            <tbody>
                                <tr>
                                    <th scope="row">Sudah Terima Dari</th>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <th scope="row">Untuk Pembayaran</th>
                                </tr>
                                <tr>
                    ...
                    <div class="col-7">
                        <table class="table table-sm">
                            <tbody>
                                ...
                                <tr>
                                    <th scope="row">:</th>
                                    <td colspan="2"><?= $invoice->alamat; ?></td>
                                </tr>
                                <tr>
                                    <th scope="row">:</th>
                                    <td colspan="2"><?= $invoice->invoice; ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="row justify-content-evenly">
                            ...
                            <table class="table table-sm table-borderless text-center">
                                <tbody>
                                    ...
                                    <tr>
                                        <td scope="row">
                                            <strong>
                                                <font color="red"><?= number_to_currency($invoice->sisa, 'IDR', 'id_ID') ?></font>
                                            </strong>
                                            <hr>
                                        </td>
                                    </tr>
                    ...
                    <div class="col-4">
                        <table class="table table-sm table-borderless ">
                            <tbody>
                                <tr>
                                    <th class="text-center" scope="row">Penerima</th>
                                </tr>
                                <tr>
