( function($) {
  'use strict';
    ...
    if ($('.pagepiling').length > 0){
		...
		$('#pp-nav').prepend('<div class="pp-nav-up"><ion-icon name="chevron-up-circle-outline"></ion-icon></div>').append('<div class="pp-nav-down"><ion-icon name="chevron-down-circle-outline"></ion-icon></div>').addClass('white right-boxed hidden-xs');
